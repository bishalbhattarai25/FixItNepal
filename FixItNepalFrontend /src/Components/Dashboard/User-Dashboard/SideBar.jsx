...
import { Wallet, HelpCircle, Bell } from "lucide-react"; // Matching icons from UI
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <main className="flex-1 overflow-y-auto p-8">
          <div className="max-w-[1400px] mx-auto">
            ...
            {activeIndex === 1 && <Requesthelp />}
            {activeIndex === 2 && <Nearbymacf />}
            {activeIndex === 3 && <Livetrack />}
            {activeIndex === 4 && <Servicehistory />}
            {activeIndex === 5 && <Wallet />}
            {activeIndex === 6 && <Maintence />}
            {activeIndex === 7 && <Profile />}
          </div>
        </main>
      </div>
    </div>
